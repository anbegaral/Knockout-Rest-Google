        ...
        //getting the beaches using FOURSQUARE API
          ...
          var date = new Date();
            ...
            $.ajax({
              ...
              self.modalTitle('Foursquare results');
              self.modalBody('An error ocurred.');
              self.modal(true);
            });
...
//Initialiasing the map
  ...
  setMarkers: function(arrayLocations){
    ...
    for (var i = 0; i < locations.length; i++) {
      ...
      this.createInfowindow(self.marker, this.infowindow, locations[i], null);
  ...
  createInfowindow: function(marker, infowindow, house, service){
    ...
    marker.addListener('click', (function(copyLocations){
      return function(){
        self.setInfoWindows(this, infowindow, copyLocations, service);
  ...
  updateMarker: function(house){
    ...
    this.createInfowindow(marker, this.infowindow, house, null);
  },
  ...
  showServicesMarkers: function(results, service){
    ...
    for (var i = 0; i < results.length; i++) {
      ...
      this.createInfowindow(marker, this.infowindow, null, service);
    }
  },
  //showing the beaches
  showBeaches: function(results){
    ...
    for (var i = 0; i < results.length; i++) {
        ...
        this.createInfowindow(marker, this.infowindow, null, results[i]);
    }
  },
